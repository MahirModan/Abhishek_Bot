...
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/464430960c6895c74a716.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/451f038b4e7c2ddd10dc0.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/5e2d4418525832bc9a1b9.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5592541592').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001834417665' '-1001967008366').split()]
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'filesgrp.link')
SHORTLINK_API = environ.get('SHORTLINK_API', '2090250a4733883836826009c3a4d5aed7a0545e')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'True')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "10")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "4444")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/akmovies22')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/punjabiflixk3')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001701265662))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'akmovies22_Support')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001701265662')).split()]
